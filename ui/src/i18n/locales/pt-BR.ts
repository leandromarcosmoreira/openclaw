...
export const pt_BR: TranslationMap = {
  common: {
    ...
    showQR: "Mostrar QR",
    relink: "Relink",
    waitForScan: "Aguardar scan",
    logout: "Sair",
    working: "Trabalhando...",
    connectedInstances: "Instâncias Conectadas",
    noInstancesReported: "Nenhuma instância reportada ainda.",
    presenceBeacons: "Beacons de presença do gateway e clientes.",
  },
  whatsapp: {
    title: "WhatsApp",
  ...
  config: {
    ...
    sectionDescs: {
      ...
      web: "Servidor web e configurações de API",
