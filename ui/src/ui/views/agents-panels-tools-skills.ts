...
export function renderAgentTools(params: {
  ...
  const profileSource = agentTools.profile
    ? t("agents.toolsPanel.sourceAgent")
    : globalTools.profile
      ? t("agents.toolsPanel.sourceGlobal")
      : t("agents.toolsPanel.sourceDefault");
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">
            ...
            <span class="mono">${enabledCount}/${toolIds.length}</span> ${t("agents.toolsPanel.enabledCount", { enabled: "", total: "" }).replace("{enabled}/{total} ", "")}
          </div>
        </div>
      ...
      <div class="agent-tools-meta" style="margin-top: 16px;">
        <div class="agent-kv">
          <div class="label">${t("agents.toolsPanel.profile")}</div>
          <div class="mono">${profile}</div>
        </div>
        <div class="agent-kv">
          <div class="label">${t("agents.toolsPanel.source")}</div>
          ...
          params.configDirty
            ? html`
                <div class="agent-kv">
                  ...
                  <div class="mono">${t("common.unsaved")}</div>
                </div>
              `
            : nothing
        }
      ...
      <div class="agent-tools-presets" style="margin-top: 16px;">
        <div class="label">${t("agents.toolsPanel.presets")}</div>
  ...
  return html`
    <section class="card">
      ...
      ${
        usingAllowlist
          ? html`
              <div class="callout info" style="margin-top: 12px">${t("agents.skillsPanel.allowlistHint")}</div>
            `
          : html`
              <div class="callout info" style="margin-top: 12px">
                ${t("agents.skillsPanel.allEnabledHint")}
              </div>
            `
      }
      ${
      ...
      <div class="filters" style="margin-top: 14px;">
        ...
        <div class="muted">${t("common.shownCount", { count: String(filtered.length) })}</div>
      </div>
  ...
  return html`
    <div class="list-item agent-skill-row">
      <div class="list-main">
        ...
        ${
          missing.length > 0
            ? html`<div class="muted" style="margin-top: 6px;">${t("agents.skillsPanel.missingPrefix")}${missing.join(", ")}</div>`
            : nothing
        }
        ${
          reasons.length > 0
            ? html`<div class="muted" style="margin-top: 6px;">${t("agents.skillsPanel.reasonPrefix")}${reasons.join(", ")}</div>`
            : nothing
        }
      </div>
      <div class="list-meta">
