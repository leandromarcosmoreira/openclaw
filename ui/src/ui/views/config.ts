        ...
        <div class="config-actions">
              ...
              hasChanges
                ? html`
                  <span class="config-changes-badge"
                    >${
                      props.formMode === "raw"
                        ? t("config.unsaved.changes")
                        : t("config.unsaved.change", { count: String(diff.length) })
                    }</span
                  >
                `
                : html`
          ...
          <div class="config-actions__right">
            ...
            <button
              ...
              @click=${props.onSave}
            >
              ${props.saving ? t("config.saving") : t("config.actions.save")}
            </button>
            <button
              class="btn btn--sm"
              ?disabled=${!canApply}
            ...
            ? html`
              <details class="config-diff">
                <summary class="config-diff__summary">
                  <span
                    >${t("config.diff.viewChanges", { count: String(diff.length) })}</span
                  >
                  <svg
