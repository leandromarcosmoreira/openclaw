        ...
        selectedDays.length > 0
          ? html`
            <div class="filter-chip">
              <span class="filter-chip-label">${t("common.days")}: ${daysLabel}</span>
            ...
            return html`
              ...
              >
                ...
                <div class="daily-bar-tooltip">
                  ...
                  ${formatTokens(d.totalTokens)} ${t("usage.tokens").toLowerCase()}<br />
...
function renderUsageInsights(
  ...
  const errorDays = aggregates.daily
    ...
    .map((day) => {
      ...
      return {
        ...
        sub: `${t("usage.errorsCount", { count: String(day.errors) })} · ${t("usage.msgsCount", { count: String(day.messages) })} · ${formatTokens(day.tokens)}`,
        rate,
      };
    })
  ...
  const topModels = aggregates.byModel.slice(0, 5).map((entry) => ({
    label: entry.model ?? t("usage.unknown"),
  ...
  const topProviders = aggregates.byProvider.slice(0, 5).map((entry) => ({
    label: entry.provider ?? t("usage.unknown"),
    value: formatCost(entry.totals.totalCost),
    sub: `${formatTokens(entry.totals.totalTokens)} · ${t("usage.msgsCount", { count: String(entry.count) })}`,
  }));
      ...
      <div class="usage-summary-grid">
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.messages")}
            <span class="usage-summary-hint" title="${t("usage.totalAssistantMessagesHint")}">?</span>
          </div>
          <div class="usage-summary-value">${aggregates.messages.total}</div>
          <div class="usage-summary-sub">
            ${t("usage.userAssistantCount", { user: String(aggregates.messages.user), assistant: String(aggregates.messages.assistant) })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.toolCalls")}
            <span class="usage-summary-hint" title="${t("usage.totalToolCallHint")}">?</span>
          </div>
          <div class="usage-summary-value">${aggregates.tools.totalCalls}</div>
          <div class="usage-summary-sub">${t("usage.toolsCount", { count: String(aggregates.tools.uniqueTools) })}</div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.errors")}
            <span class="usage-summary-hint" title="${t("usage.totalErrorHint")}">?</span>
          </div>
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ...
            <span class="usage-summary-hint" title=${t("usage.avgTokensPerMsgHint")}>?</span>
          </div>
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ...
            <span class="usage-summary-hint" title=${costHint ? t("usage.avgCostPerMsgMissingHint") : t("usage.avgCostPerMsgHint")}>?</span>
          </div>
          <div class="usage-summary-value">${formatCost(avgCost, 4)}</div>
          <div class="usage-summary-sub">${t("usage.totalCostAmount", { total: formatCost(totals.totalCost) })}</div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.sessions")}
          ...
          <div class="usage-summary-sub">${t("usage.of")} ${totalSessions} ${t("usage.inInRange")}</div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.throughput")}
            <span class="usage-summary-hint" title=${t("usage.throughputHint")}>?</span>
          </div>
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.errorRate")}
            <span class="usage-summary-hint" title=${t("usage.errorHint")}>?</span>
          </div>
          <div class="usage-summary-value ${errorRatePct > 5 ? "bad" : errorRatePct > 1 ? "warn" : "good"}">${errorRatePct.toFixed(2)}%</div>
          <div class="usage-summary-sub">
            ${t("usage.errorsCount", { count: String(aggregates.messages.errors) })} · ${avgDurationLabel} ${t("usage.avgSession")}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usage.cacheHitRate")}
            <span class="usage-summary-hint" title=${t("usage.cacheHint")}>?</span>
          </div>
          <div class="usage-summary-value ${cacheHitRate > 0.6 ? "good" : cacheHitRate > 0.3 ? "warn" : "bad"}">${cacheHitLabel}</div>
          <div class="usage-summary-sub">
            ${formatTokens(totals.cacheRead)} ${t("usage.cached").toLowerCase()} · ${formatTokens(cacheBase)} ${t("usage.prompt").toLowerCase()}
          </div>
        </div>
      </div>
    ...
    <div class="card sessions-card">
      <div class="sessions-card-header">
        ...
        <div class="sessions-card-count">
          ${t("common.shownCount", { count: String(sessions.length) })}${totalSessions !== sessions.length ? ` · ${t("usage.totalCostAmount", { total: String(totalSessions) })}` : ""}
        </div>
      </div>
      ...
      ${
        sessionsTab === "recent"
          ...
          : sessions.length === 0
            ? html`
                <div class="muted" style="padding: 20px; text-align: center">${t("usage.noSessionsInRangeMsg")}</div>
              `
            : html`
	                <div class="session-bars">
	                  ...
	                  ${sessions.length > 50 ? html`<div class="muted" style="padding: 8px; text-align: center; font-size: 11px;">${t("usage.moreSessions", { count: String(sessions.length - 50) })}</div>` : nothing}
	                </div>
	              `
      }
      ${
